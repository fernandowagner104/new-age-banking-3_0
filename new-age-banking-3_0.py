   ...
   def __init__(self, numero, cliente):
    ...
    def sacar(self, valor):
        ...
        if excedeu_saldo:
            ...
            print("\n O saque não foi realizado! O valor fornecido é inválido!")
    ...
    def depositar(self, valor):
        if valor > 0:
            ...
            print("\n O depósito não foi realizado! O valor fornecido é inválido! ")
            return False
...
class ContaCorrente(Conta):
    ...
    def sacar(self, valor): # Sobreescrita do método sacar(), que é da classe Conta
        ...
        if excedeu_limite:
            print("\n O limite de saque foi excedido!")
            
        elif excedeu_saques:
            print("\n O número de saques diários foi excedido!")
